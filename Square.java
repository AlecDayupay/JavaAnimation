...
/**
    Square.java implements DrawingObject.java interface. Square.java 
    uses an instance of Rectangle2D.Double() to draw a Square.
*/
...
public class Square implements DrawingObject{
    ...
    public void draw(Graphics2D g2d){
        ...
        g2d.rotate(Math.toRadians(rotation));
            ...
            Rectangle2D.Double bg = new Rectangle2D.Double(x, y, size, size);
            g2d.setPaint(color);
            g2d.fill(bg);
